...
{
    opt.SwaggerDoc("v1", new OpenApiInfo { Title = "Smadot_AdministracionStock_Api", Version = "v1" });
...
builder.Services.AddScoped<IAsignacionStock, AsignacionStock>();
builder.Services.AddScoped<IDevolucionSPFNegocio, DevolucionSPFNegocio>();
builder.Services.AddScoped<IEquipoNegocio, EquipoNegocio>();
builder.Services.AddScoped<IProgramacionCalibracionNegocio, ProgramacionCalibracionNegocio>();
builder.Services.AddScoped <ICalibracionNegocio, CalibracionNegocio>();
builder.Services.AddScoped<SmadsotGenericInserts, SmadsotGenericInserts>();
