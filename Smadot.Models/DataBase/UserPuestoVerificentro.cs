...
public partial class UserPuestoVerificentro
{
    ...
    public virtual ICollection<HorarioUserPuestoVerificentro> HorarioUserPuestoVerificentros { get; } = new List<HorarioUserPuestoVerificentro>();

    public virtual CatEstatusPuesto IdCatEstatusPuestoNavigation { get; set; } = null!;
    ...
    public virtual ICollection<AceditacionTecnicoSolicitud> IdAcreditacionTecnicoSolicituds { get; } = new List<AceditacionTecnicoSolicitud>();
}
