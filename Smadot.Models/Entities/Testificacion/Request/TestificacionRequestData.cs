...
namespace Smadot.Models.Entities.Testificacion.Request
{
    public class TestificacionApiRequest
    {
        ...
        public List<TestificacionFiles> Files { get; set; }
        public string PersonaTramite { get; set; }
    }


    public class TestificacionFiles
    {
