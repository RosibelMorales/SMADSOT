...
{
    public class TestificacionHelper
    {
        public static async Task<ResponseViewModel> Consulta(IProxyWebAPI _proxyWebAPI, ReposicionCredencialListRequest req)
        {
            try
            {
                ...
                var request = await _proxyWebAPI.GetAsyncData<ResponseGrid<TestificacionResponseGrid>>("gateway/Testificacion" + query);
        ...
        public static async Task<ResponseViewModel> Guardar(IProxyWebAPI _proxyWebAPI, TestificacionApiRequest registro)
        {
            try
            {
                ...
                var request = await _proxyWebAPI.PostAsyncData<bool>(string.Format("/gateway/Testificacion"), stringContent);
        ...
        public static async Task<ResponseViewModel> GetById(IProxyWebAPI _proxyWebAPI, long id)
        {
            try
            {
                var request = await _proxyWebAPI.GetAsyncData<TestificacionResponse>($"gateway/Testificacion/{id}");
        ...
        public static async Task<ResponseViewModel> Eliminar(IProxyWebAPI _proxyWebAPI, long id)
        {
            try
            {
                var request = await _proxyWebAPI.DeleteAsync<bool>($"gateway/Testificacion/{id}");
