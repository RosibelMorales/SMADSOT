...
namespace Smadot.Web.Controllers.Mantenimiento
{
    ...
    public class LaboratorioController : Controller
    {
        ...
        public LaboratorioController(IProxyWebAPI proxyWebAPI, IUserResolver userResolver)
        {
        ...
        {
            if (!_userResolver.HasPermission(MenuLaboratorios.PermisoMenuPadre))
                return new UnauthorizedResult();
            return View("~/Views/Laboratorio/Index.cshtml");
        }
        [HttpPost]
        public async Task<JsonResult> Consulta()
        {
            ...
            foreach (var row in data)
            {
                List.Add(new ProveedorResponseGrid
                {
                    ...
                    Acciones = await this.RenderViewToStringAsync("~/Views/Laboratorio/_Acciones.cshtml", row)
                });
            }
        ...
        public async Task<ActionResult> Registro()
        {
            ...
            try
            {
                ...
                result.Result = await this.RenderViewToStringAsync("~/Views/Laboratorio/_Registro.cshtml", response);
            }
            catch (Exception ex)
            {
        ...
        public async Task<ActionResult> Detalle(long id)
        {
            ...
            try
            {
                ...
                result.Result = await this.RenderViewToStringAsync("~/Views/Laboratorio/_Detalle.cshtml", response);
            }
            catch (Exception ex)
            {
                result.IsSuccessFully = false;
