    ...
    if (validator) {
        validator.validate().then(async function (status) {
            if (status == 'Valid') {
                ...
                //files.push(Dropzone.forElement("#dropzonejs5").files[0]);
                files.push(Dropzone.forElement("#dropzonejs1").files[0]);
                ...
                var Data = {
                    ...
                    HorarioRequest: [
                        { id: $('#Id-Lunes').val(), dia: $('#Dia-Lunes').val(), horaInicio: $('#HoraInicio-Lunes').val(), horaFin: $('#HoraFin-Lunes').val() },
                        { id: $('#Id-Martes').val(), dia: $('#Dia-Martes').val(), horaInicio: $('#HoraInicio-Martes').val(), horaFin: $('#HoraFin-Martes').val() },
                        { id: $('#Id-Miercoles').val(), dia: $('#Dia-Miercoles').val(), horaInicio: $('#HoraInicio-Miercoles').val(), horaFin: $('#HoraFin-Miercoles').val() },
                        { id: $('#Id-Jueves').val(), dia: $('#Dia-Jueves').val(), horaInicio: $('#HoraInicio-Jueves').val(), horaFin: $('#HoraFin-Jueves').val() },
                        { id: $('#Id-Viernes').val(), dia: $('#Dia-Viernes').val(), horaInicio: $('#HoraInicio-Viernes').val(), horaFin: $('#HoraFin-Viernes').val() },
                        { id: $('#Id-Sabado').val(), dia: $('#Dia-Sabado').val(), horaInicio: $('#HoraInicio-Sabado').val(), horaFin: $('#HoraFin-Sabado').val() },
                        { id: $('#Id-Domingo').val(), dia: $('#Dia-Domingo').val(), horaInicio: $('#HoraInicio-Domingo').val(), horaFin: $('#HoraFin-Domingo').val() },
                    ],
                ...
                $.ajax({
                    ...
                    url: siteLocation + 'Personal/Editar',
                    dataType: 'json',
                    ...
                    success: function (result) {
                        if (!result.isSuccessFully) {
                            ...
                            toastr.success("Se actualizo la información exitosamente", "");
