    ...
    var abrirModal = function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('#modal_registro #modalLabelTitle').html('Registrar Laboratorio');
...
var modalDetalle = function () {
    ...
    var abrirModal = function (id) {
        ...
        $.ajax({
            cache: false,
            type: 'GET',
            url: 'Laboratorio/Detalle/' + id,
            success: function (result) {
                if (!result.isSuccessFully) {
                    toastr.error(result.message, "SMADSOT");
                    return;
                }
                $('#modal_registro #modalLabelTitle').html('Detalle de Laboratorio');
...
var Confirmar = function () {
    ...
    var abrirModal = function (id, nombre, estatus) {
        ...
        Swal.fire({
            html: '¿Está seguro que desea ' + est + ' al técnico del laboratorio <strong>' + nombre + '</strong>?',
            icon: "info",
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    url: siteLocation + "Laboratorio/EstatusProveedor",
                    processData: false,
                    contentType: false,
                    //dataType: 'json',
                    data: formData,
