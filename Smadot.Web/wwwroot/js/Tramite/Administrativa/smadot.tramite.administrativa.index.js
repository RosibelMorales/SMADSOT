    ...
    var init = function () {
        datatable = $('#kt_datatable').DataTable({
            ...
            columns: [
                ...
                { data: 'motivoTramite', name: 'MotivoTramite', title: 'Motivo de trámite' },
                ...
                { data: 'folioAsignado', name: 'FolioAsignado', title: 'Folio asignado' },
...
//    location.href = siteLocation + "Administrativa/Detalle/" + id;
//});
...
var GenerarPDF = function () {
    ...
    var generar = function (id) {
        $.ajax({
            ...
            url: '/Refrendo/GetPDFFormaValorada?id=' + id,
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    cache: false,
                    type: 'DELETE',
                    url: 'Administrativa/EliminarRegistro?id=' + id,
                    success: function (result) {
                        if (result.error) {
                            toastr.error(result.message, 'SMADSOT');
                            return;
