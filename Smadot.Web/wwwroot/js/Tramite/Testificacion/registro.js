...
var KTDatatableRemoteAjax = function () {
    ...
    var init = function () {
        ...
        $("#FechaEmisionReferencia, #FechaPago,#VigenciaOrigen").daterangepicker({
        ...
        $("#btnGuardarTestificacion").click(function (e) {
            e.preventDefault();
            //toastr.success('Registro guardado exitosamente', "SMADSOT");
            GuardarTestificacion.init();
        });
    ...
    //            $.ajax({
    //                url: siteLocation + "Testificacion/ConsultaAutocomplete",
    //                type: "POST",
    //                dataType: "json",
    //                data: {
    //                    prefix: request.term
...
var GuardarTestificacion = function () {
    var validation; // https://formvalidation.io/
        ...
        validation.validate().then(async function (status) {
            ...
            if (status === 'Valid') {
                ...
                $.ajax({
                    ...
                    url: siteLocation + "Testificacion/CreateTestificacion",
                    processData: false,
                    contentType: false,
                    //dataType: 'json',
                    data: formSent,
            ...
            form,
            {
                fields: {
                    ...
                    , PersonaTramite: {
                        validators: {
                            notEmpty: {
                                message: 'Debe agregar el nombre de la persona que realiza trámite.'
                            },
                        }
                    }
