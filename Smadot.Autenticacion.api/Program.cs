...
{
    opt.SwaggerDoc("v1", new OpenApiInfo { Title = "Smadsot_Autenticacion_Api", Version = "v1" });
...
builder.Services.AddScoped<IAutorizacionTecnicoAppNegocio, AutorizacionTecnicoAppNegocio>();
