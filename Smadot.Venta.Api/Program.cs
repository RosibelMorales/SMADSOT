...
using System.Text;
using Smadot.Utilities.CognitiveServices.Classes;
...
builder.Services.AddSingleton<IListGeneric, ListGeneric>();
builder.Services.AddScoped<IUserResolver, UserResolver>();
builder.Services.AddScoped<IVentaCVVNegocio, VentaCVVNegocio>();
builder.Services.AddScoped<IProveedorNegocio, ProveedorNegocio>();
builder.Services.AddScoped<IProveedorFolioServicioNegocio, ProveedorFolioServicioNegocio>();
builder.Services.AddScoped<IOrdenServicioNegocio, OrdenServicioNegocio>();
builder.Services.AddScoped<IConfiguracionLayoutNegocio, ConfiguracionLayoutNegocio>();
builder.Services.AddScoped<IEventosVerificentroNegocio, EventosVerificentroNegocio>();
...
builder.Services.AddScoped<IFormaValoradaNegocio, FormaValoradaNegocio>();
builder.Services.AddScoped<IComputerVisionService, ComputerVisionService>();
builder.Services.AddScoped<ICustomVision, CustomVision>();
